...
typedef struct {
    const char *full;	/* full name */
    const char *tag;	/* Roman numeral tag */
...
extern const char *cns_name (int id);
...
extern int db_tle (int whichname, char *name, char *l1, char *l2, Obj *op);
...
extern const char *obj_description (Obj *op);
