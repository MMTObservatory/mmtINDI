...
/* flag any callback can set to cause eventLoop() to return */
extern volatile int eloop_error;

/* For RCS Only -- Do Not Edit
 * @(#) $RCSfile: eventloop.h,v $ $Date: 2007/06/24 02:36:26 $ $Revision: 1.1.1.1 $ $Name:  $
 */
